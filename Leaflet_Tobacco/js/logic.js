...
d3.json("../data/state.json").then(function(data) {
  ...
  // Create second layer for tobacco
  ...
  // Create a third layer for tobacco
  ...
  // Create a fourth layer for tobacco
  ...
  // Create a fifth layer for tobacco
  ...
  // Create a sixth layer for tobacco
